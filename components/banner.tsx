    ...
    >
      <div className="relative w-full">
        <div className="flex items-center justify-center">
          <p className="text-sm font-normal">
            ...
            <Link
              ...
              className="text-indigo-600 transition-opacity hover:opacity-75"
            >
              fork this repo
            </Link>{" "}
            or{" "}
        ...
        <button
          ...
          type="button"
          className="absolute right-0 top-3/4 -translate-y-1/2 rounded-full border border-slate-300 bg-slate-50 p-1 opacity-80 hover:opacity-90 sm:top-1/2"
        >
